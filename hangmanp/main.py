...
#Determine if the character in the anser needs to be guessed.
...
if letter not in guessd_letters and len(letters)==1 and re.search("^[A-Z]$", letter):
    # Process the letter in the puzzle.
    guesse_letters_insert_index = 0
    ...
    guessed_letter.insert(guessed_letter_insert_index, letter)
